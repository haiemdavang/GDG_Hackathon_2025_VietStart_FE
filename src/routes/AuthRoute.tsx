...
export function AuthoPage() {
  ...
  return (
    <div className="min-h-[90vh] font-['Inter'] overflow-hidden relative bg-white">
      ...
      <div className={`w-[100vw] h-[100vh] flex [&>*]:flex-shrink-0 duration-1000 transition-all ${location.pathname === "/login" ? "translate-x-0" : "-translate-x-1/2"
        }`}>
        <SignIn />

        <div className={`w-1/2 bg-primary/10 flex flex-col items-center gap-4 justify-center duration-200 transition-all ease-in-out ${location.pathname === "/login" ? "rounded-l-[200px]" : "rounded-r-[200px]"
          }`}>
